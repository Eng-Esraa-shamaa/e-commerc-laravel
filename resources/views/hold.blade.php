...
<body>
<a href="{{URL('offer')}}"><img src="images/download.png" class="img-head" alt=""></a>
<div class="header">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="{{URL('care')}}"><img class="first-slide" src="images/ba2.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
          <a href="{{URL('care')}}"><img class="second-slide " src="images/ba.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
         <a href="{{URL('hold')}}"> <img class="third-slide " src="images/ba1.jpg" alt="Third slide"></a>
	...
	<div class="container">
		...
		<div class="clearfix"></div>
			<div class="footer-bottom">
				<h2 ><a href="{{URL('Home')}}"><b>T<br>H<br>E</b>Big Store<span>The Best Supermarket</span></a></h2>
