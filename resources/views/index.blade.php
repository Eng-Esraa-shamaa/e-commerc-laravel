...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="{{URL('Home')}}"><b>T<br>H<br>E</b>Big Store<span>The Best Supermarket</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
								...
								<ul class="dropdown-menu multi">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="{{URL('kitchen')}}"><img src="images/me.png" class="img-responsive" alt=""></a>
										</div>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="{{URL('care')}}"><img src="images/me1.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="{{URL('hold')}}"><img src="images/me2.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
						...
						<div class=" con-w3l">
							<div class="col-md-3 m-wthree">
								<div class="col-m">								
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Moong</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Sunflower Oil</a>(5 kg)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Kabuli Chana</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Soya Chunks</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
						...
						<div class=" con-w3l">
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Lays</a>(100 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Kurkure</a>(100 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$1.00</label><em class="item_price">$0.70</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Popcorn</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Nuts</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
											  <div class="block">
						...
						<div class=" con-w3l">
							<div class="col-md-3 m-wthree">
								...
								<a href="#" data-toggle="modal" data-target="#myModal9" class="offer-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Banana</a>(6 pcs)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$2.00</label><em class="item_price">$1.50</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Onion</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$1.00</label><em class="item_price">$0.70</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}"> Bitter Gourd</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$2.00</label><em class="item_price">$1.00</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Apples</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
											  <div class="block">
					...
					<div class="tab-pane text-style" id="tab4">
							...
							<div class="col-md-3 m-wthree">
								...
								<a href="#" data-toggle="modal" data-target="#myModal13" class="offer-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Honey</a>(500 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m ">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Chocos</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m ">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Oats</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
											  <div class="block">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Bread</a>(500 g)</h6>							
										</div>
										<div class="mid-2">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
         <a href="{{URL('kitchen')}}"> <img class="first-slide" src="images/ba.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
         <a href="{{URL('care')}}"> <img class="second-slide " src="images/ba1.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
          <a href="{{URL('hold')}}"><img class="third-slide " src="images/ba2.jpg" alt="Third slide"></a>
				...
				<div class=" con-w3l">
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal17" class="offer-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Moisturiser</a>(500 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$7.00</label><em class="item_price">$6.00</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">  Lady Finger</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$5.00</label><em class="item_price">$4.50</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}"> Ribbon</a>(1 pc)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Grapes</a>(500 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$1.00</label><em class="item_price">$0.80</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal21" class="offer-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Clips</a>(1 pack)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$7.00</label><em class="item_price">$6.00</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Conditioner</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$5.00</label><em class="item_price">$4.50</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Cleaner</a>(250 kg)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="{{URL('single')}}">Gel</a>(150 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$1.00</label><em class="item_price">$0.80</em></p>
											  <div class="block">
